...
//sysUser.js文件中定义的方法
import {DoAssignRoleToUser, GetSysUserListByPage , SaveSysUser , UpdateSysUser,DeleteSysUserById } from '@/api/sysUser';
...
//得到所有角色
  ...
  allRoles.value = data.allRolesList//data.put("allRolesList", sysRoleList);

  //用户分配过的角色
  userRoleIds.value = data.sysUserRoles//data.put("sysUserRoles", roleIds);
}
// 角色分配按钮事件处理函数
